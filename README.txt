Dashboard Executivo RA3 - Projeto Flow

Como usar:
1. Extraia o arquivo .zip em uma pasta.
2. Abra o arquivo index.html no navegador.
3. Passe o mouse sobre barras, riscos e cards para ver interações.
4. Use os filtros do cronograma e a busca de tarefas.
